				...
				<div className="login-bg">
					<div className="rounded-md bg-white p-8 shadow-md">
						<div className="my-6 flex items-center justify-center space-x-2">
							...
							<span className="dark--text text-3xl font-semibold">TwilightUI</span>
						</div>
						<div className="my-3">
							<p className="dark--text my-2 text-2xl font-semibold">Welcome to Twilight!</p>
						...
						<form className="mt-4">
							...
							<div className="mt-4 flex items-center justify-between">
								...
								<a
									className="fontme block text-sm text-primary-600 hover:underline"
							...
							<div className="mt-6">
								<a href="/index.html" className="btn btn-primary block">
									{' '}
